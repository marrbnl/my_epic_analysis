...
const int etabin = 4;
static double eta_lo[etabin] = {-3,-1,1,-3};
static double eta_hi[etabin] = {-1,1,3,3};
const int eta_color[etabin] = {kGreen+1, kBlue, kOrange+1, kRed};
...
const int nubin = 7;
static double nu_lo[nubin] = {5E0, 1E1, 5E1, 1E2, 5E2, 1E0, 1E3};
static double nu_hi[nubin] = {1E1, 5E1, 1E2, 5E2, 1E3, 1E3, 5E3};
const int nu_color[nubin] = {kGreen+1, kBlue, kViolet, kOrange+1, kRed, kPink+1, kGray+1};

// const int xbin = 9;
// static double x_lo[xbin] = {1E-4, 5E-4, 1E-3, 5E-3, 1E-2, 5E-2, 1E-1, 1E-1, 5E-1};
// static double x_hi[xbin] = {5E-4, 1E-3, 5E-3, 1E-2, 5E-2, 1E-1, 1E-1, 5E-1, 1E0};
